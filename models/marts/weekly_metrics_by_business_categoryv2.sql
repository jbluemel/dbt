...
with weekly_data as (
    select
        ...
        "Auction Category" as business_category,
...
group by fiscal_year, fiscal_week_number, business_category
order by fiscal_year, fiscal_week_number, business_category